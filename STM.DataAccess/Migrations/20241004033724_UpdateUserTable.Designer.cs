...
namespace STM.DataAccess.Migrations
{
    ...
    [Migration("20241004033724_UpdateUserTable")]
            ...
            modelBuilder.Entity("STM.Entities.Models.Setting", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("bcdfc7af-1e2c-41a1-9f23-7199eecce863"),
                            Key = "webName",
                            Status = 1,
                            Type = "general"
                        },
                        new
                        {
                            Id = new Guid("753222fe-1305-4b9d-90ec-7f72b0967934"),
                            Key = "phone",
                            Status = 1,
                            Type = "general"
                        },
                        new
                        {
                            Id = new Guid("78d2f8f0-5e51-4c34-8c95-12f944ab223f"),
                            Key = "email",
                            Status = 1,
                            Type = "general"
                        },
                        new
                        {
                            Id = new Guid("3c989e26-a953-49c1-8aa2-87bc71d4c573"),
                        ...
                        new
                        {
                            Id = new Guid("8a8d6e3d-f6ac-4816-aa9b-d693b0b6c2a6"),
                            Key = "province",
                            Status = 1,
                            Type = "general"
                        },
                        new
                        {
                            Id = new Guid("e970f254-f3c1-465f-a1af-2be7da94b11e"),
                            Key = "district",
                            Status = 1,
                            Type = "general"
                        },
                        new
                        {
                            Id = new Guid("19b67f70-9d0b-4f9b-83a6-d8b4c40f0311"),
                            Key = "village",
                            Status = 1,
                            Type = "general"
                        },
                        new
                        {
                            Id = new Guid("9b86c549-3189-4fd3-915a-300d6ed2e91c"),
                            Key = "Address",
                            Status = 1,
                            Type = "general"
                        },
                        new
                        {
                            Id = new Guid("929e3880-5c15-4d31-8047-3d7da7cbd118"),
                            Key = "timeZone",
                            Status = 1,
                            Type = "general"
                        },
                        new
                        {
                            Id = new Guid("4168abf9-6035-4b1e-bba4-ad541290d9d3"),
                            Key = "currency",
                            Status = 1,
                            Type = "general"
                        },
                        new
                        {
                            Id = new Guid("d203f04e-da14-44af-8d5f-f4da0141f45d"),
                        ...
                        new
                        {
                            Id = new Guid("2a3373ff-65b3-40ce-8043-51a829cd0fc5"),
            ...
            modelBuilder.Entity("STM.Entities.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAELDVsvy3zncb5N0mjACSNTjCtXBggD2w2tR+Qo4N7RfxbRbW/8FeA1FHiEBl2mYxoA==",
