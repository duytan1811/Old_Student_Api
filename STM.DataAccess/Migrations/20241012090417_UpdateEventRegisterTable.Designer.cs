...
namespace STM.DataAccess.Migrations
{
    ...
    [Migration("20241012090417_UpdateEventRegisterTable")]
    partial class UpdateEventRegisterTable
    {
            ...
            modelBuilder.Entity("STM.Entities.Models.Setting", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("e77fbc74-818a-414c-9f1e-f1971ed3b13b"),
                            Key = "webName",
                            Status = 1,
                            Type = "general"
                        },
                        new
                        {
                            Id = new Guid("8f879a1b-de02-4b83-a922-969a3933950c"),
                            Key = "phone",
                            Status = 1,
                            Type = "general"
                        },
                        new
                        {
                            Id = new Guid("553b32b6-d02a-488d-9d97-25bbb637cd30"),
                            Key = "email",
                            Status = 1,
                            Type = "general"
                        },
                        new
                        {
                            Id = new Guid("91032d35-f529-43ad-ade8-6b9db6f52013"),
                        ...
                        new
                        {
                            Id = new Guid("09c69c66-adf0-4e0a-8444-4a330d5d5e80"),
                            Key = "province",
                            Status = 1,
                            Type = "general"
                        },
                        new
                        {
                            Id = new Guid("d5cc836d-b9be-4ee5-8981-63a909aa5070"),
                            Key = "district",
                            Status = 1,
                            Type = "general"
                        },
                        new
                        {
                            Id = new Guid("9797de1c-e216-4a8f-9dfe-c3d10f285b47"),
                            Key = "village",
                            Status = 1,
                            Type = "general"
                        },
                        new
                        {
                            Id = new Guid("204fb6ab-c09d-461a-838f-a64a410edc3b"),
                            Key = "Address",
                            Status = 1,
                            Type = "general"
                        },
                        new
                        {
                            Id = new Guid("710e30a8-05d8-4a1c-8c0b-0449a333f2d2"),
                            Key = "timeZone",
                            Status = 1,
                            Type = "general"
                        },
                        new
                        {
                            Id = new Guid("b128503c-84c5-4147-b864-4bb60ed3d925"),
                            Key = "currency",
                            Status = 1,
                            Type = "general"
                        },
                        new
                        {
                            Id = new Guid("9ebccb75-7684-41f3-8690-96edc6419546"),
                        ...
                        new
                        {
                            Id = new Guid("a242eff4-3d9d-46da-99d1-037b566601a6"),
            ...
            modelBuilder.Entity("STM.Entities.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEJqaOtfgomdZQs1gqrnGw7GnuX3AMiOyAEXHiAX44kYvevYf3h3K8tdwbVNrId1dUA==",
