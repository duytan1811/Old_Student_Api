...
namespace STM.DataAccess.Migrations
{
    ...
    [Migration("20241012090126_AddEventRegisterTable")]
    partial class AddEventRegisterTable
    {
            ...
            modelBuilder.Entity("STM.Entities.Models.Setting", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("ef8805bf-2d26-4fa4-96bb-3d5bd12eaab3"),
                            Key = "webName",
                            Status = 1,
                            Type = "general"
                        },
                        new
                        {
                            Id = new Guid("10ff9ac5-a259-4d65-aa7e-8cf380c73b02"),
                            Key = "phone",
                            Status = 1,
                            Type = "general"
                        },
                        new
                        {
                            Id = new Guid("b55a9b51-360d-4665-9787-a2dc2d8e3d94"),
                            Key = "email",
                            Status = 1,
                            Type = "general"
                        },
                        new
                        {
                            Id = new Guid("8ec2fd43-8596-468a-b666-f5dc66afc49b"),
                        ...
                        new
                        {
                            Id = new Guid("18e16188-b140-4a48-872b-3da088a77c4e"),
                            Key = "province",
                            Status = 1,
                            Type = "general"
                        },
                        new
                        {
                            Id = new Guid("eba4ce6d-c9a8-403d-8430-101d80e08ad8"),
                            Key = "district",
                            Status = 1,
                            Type = "general"
                        },
                        new
                        {
                            Id = new Guid("3c68e844-7c0b-4e7b-b1bb-1dcab3b628e1"),
                            Key = "village",
                            Status = 1,
                            Type = "general"
                        },
                        new
                        {
                            Id = new Guid("99e51f2d-b4ee-48b9-8479-4b7dbc30d8fd"),
                            Key = "Address",
                            Status = 1,
                            Type = "general"
                        },
                        new
                        {
                            Id = new Guid("38e56956-c95c-4353-b1f2-bf844f72bb5b"),
                            Key = "timeZone",
                            Status = 1,
                            Type = "general"
                        },
                        new
                        {
                            Id = new Guid("4c160980-a169-4387-b2ac-9bcc9838745b"),
                            Key = "currency",
                            Status = 1,
                            Type = "general"
                        },
                        new
                        {
                            Id = new Guid("a604a433-a166-4a36-bc9f-53c6e1f9c0e8"),
                        ...
                        new
                        {
                            Id = new Guid("c592a60a-1beb-43f6-a58a-2775ce3fba1b"),
            ...
            modelBuilder.Entity("STM.Entities.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEKV8HRI+urvmgTh+0168lwITN/LSo62Yq10guBnWsHN3lwuAA67cX4WpIw2zBslvww==",
